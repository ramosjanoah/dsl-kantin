...
def mau(action) {
    //exp: mau bayar_pesanan sebesar "800"
...
def pelanggan(action) {
    keluar: [ kantin: {pelangganKeluar()} ]
    konfirmasi: [pesanan: {konfirmasiPesanan()} ]
    masuk: [ untuk : { mode -> pelangganMasuk(mode) }]
